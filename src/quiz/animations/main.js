...
function animateImages() {
    return __awaiter(this, void 0, void 0, function () {
        var alice10Animation, alice20Animation, alice30Animation, animations;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(alice10 && alice20 && alice30)) return [3 /*break*/, 5];
                    return [4 /*yield*/, alice10.animate(aliceTumbling1, aliceTiming1).finished];
                case 1:
                    alice10Animation = _a.sent();
                    return [4 /*yield*/, alice20.animate(aliceTumbling1, aliceTiming1).finished];
                case 2:
                    alice20Animation = _a.sent();
                    return [4 /*yield*/, alice30.animate(aliceTumbling1, aliceTiming1).finished];
                case 3:
                    alice30Animation = _a.sent();
                    return [4 /*yield*/, Promise.all([alice10Animation, alice20Animation, alice30Animation])];
                case 4:
                    animations = _a.sent();
...
function runAnimation() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, animateImages()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
